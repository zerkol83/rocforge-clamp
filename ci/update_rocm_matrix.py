#!/usr/bin/env python3
"""Update the ROCm matrix with new container tags from GHCR."""
import argparse
...
HEADERS = {
    ...
    "User-Agent": "Clamp-ROCm-Updater/1.0",
}
...
def main() -> int:
    ...
    except Exception as exc:  # pragma: no cover - handler for CI visibility
